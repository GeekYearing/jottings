...
//  LCD初始化、显示函数   （4线SPI GC9A01A+1.09ips圆屏-240*240 SPI1 @STM32F103C8T6 MDK5.14）                                          //
...
///////初始化SPI端口////////////////
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_SPI1,ENABLE);	 //使能SPI1端口时钟
  ...
  SPI_InitStructure.SPI_NSS = SPI_NSS_Soft;//NSS信号由软件管理
	...
	SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_4;//波特率预分频值：波特率预分频值为4   //CS 接GND 一定要改为预分频4
...
void STM_Port_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_7;   //PA5 -SCL    PA7  MOSI
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
	GPIO_Init(GPIOA, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3;	 //PA0-RES   PA1---DC  PA2---CS  PA3---BLK
